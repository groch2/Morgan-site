...
var thinestPicture = picturesSizeRatio.First(psr => psr.Item2 == minSizeRatio).Item1;

var maxSizeRatio = picturesSizeRatio.Max(psr => psr.Item2);
var strechedestPicture = picturesSizeRatio.First(psr => psr.Item2 == maxSizeRatio).Item1;
